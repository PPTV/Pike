 ...
 */
class ExclusiveQueueWithBinding implements QueueDeclaration {
    ...
    public Queue.DeclareOk declare(Channel channel) throws IOException {
    	...
    	/*create a mirror queue on each node*/
    	  Map<String, Object> args = new HashMap<String, Object>();
          args.put("x-ha-policy", "all");
        final Queue.DeclareOk queue = channel.queueDeclare();

        channel.queueBind(queue.getQueue(), exchange, routingKey,args);
