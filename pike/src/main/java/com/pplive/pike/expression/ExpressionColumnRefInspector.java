...
public final class ExpressionColumnRefInspector implements IExpressionVisitor {

	public static boolean containsColumnOrVariableReference(AbstractExpression expr) {
		return new ExpressionColumnRefInspector().visit(null, expr);
	}
	
	private ExpressionColumnRefInspector(){}
