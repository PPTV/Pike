...
public final class NotEqualOp extends AbstractCompareOp {

	private static final long serialVersionUID = 7965777604315927192L;

	public static final String Op = "<>";
	
	public static Boolean eval(Boolean left, Boolean right){
		if (left == null || right == null)
			return null;
		return left != right.booleanValue();
	}
	...
	public static Boolean eval(Object left, String right) {
		if (left == null || right == null)
			return null;
		return left.toString().equalsIgnoreCase(right) == false;
	}
	
	public static Boolean eval(String left, Object right) {
		if (left == null || right == null)
			return null;
		return left.equalsIgnoreCase(right.toString()) == false;
	}
	
	public static Boolean eval(String left, String right) {
		if (left == null || right == null)
			return null;
		return left.equalsIgnoreCase(right) == false;
	}
}
