...
public final class AddOp extends AbstractArithmeticOp {
	...
	// promote to String
	public static String eval(Object left, String right) {
		if (left == null || right == null)
			return null;
		return left + right;
	}
	
	public static String eval(String left, Object right) {
		if (left == null || right == null)
			return null;
		return left + right;
	}
	
	public static String eval(String left, String right) {
		if (left == null || right == null)
			return null;
		return left + right;
	}
