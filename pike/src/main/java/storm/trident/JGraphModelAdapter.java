    ...
    extends DefaultGraphModel
{
    ...
    void handleJGraphTAddedVertex(V jtVertex)
    {
        ...
        AttributeMap attrs = createVertexAttributeMap(vertexCell);
        AttributeMap overrideAttrs = cellFactory.createVertexCellAttributes(jtVertex);
        if (overrideAttrs != null) {
        	((Map)attrs.get(vertexCell)).putAll(overrideAttrs);
        }
    ...
    public static interface CellFactory<VV, EE>
    {
        ...
        public AttributeMap createVertexCellAttributes(VV jGraphTVertex);
        public AttributeMap createEdgeCellAttributes(EE jGraphTEdge);
    }
